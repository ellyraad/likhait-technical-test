...
RSpec.describe "Api::Expenses", type: :request do
  ...
  let!(:newer_expense) { Expense.create!(description: "Lunch", amount: 100.00, category: food_category, date: Date.new(2026, 1, 1)) }
  let!(:older_expense) { Expense.create!(description: "Taxi", amount: 50.00, category: transport_category, date: Date.new(2025, 12, 31)) }
